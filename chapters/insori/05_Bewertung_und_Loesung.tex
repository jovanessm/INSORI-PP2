...
Fortschritt dar. Sie lösen die Souveränitätsprobleme jedoch 
nicht vollständig.
...
Gebühren für ausgehenden Datenverkehr im Kontext von Anbieterwechseln und 
...
etwa kontrolliert das Unternehmen \ac{TSMC} über 90 Prozent der weltweiten 
...
das Verbot der Gebühren für ausgehenden Datenverkehr ausschließlich im Kontext eines 
vollständigen Anbieterwechsels. Laufende 
Datentransferkosten im Cloud-Betrieb bleiben weiterhin 
zulässig.

Die rechtliche Exposition gegenüber dem \ac{CLOUD-Act}
...
nicht-personenbezogene Daten (vgl. Kapitel \ref{sec:data-act}). Personenbezogene Daten 
fallen weiterhin ausschließlich unter die \ac{DSGVO}, sodass 
der in Kapitel \ref{sec:cloudact} beschriebene 
Jurisdiktionskonflikt fortbesteht. 

Auch bei der Nutzung souveräner Cloud-Angebote der Hyperscaler (vgl. Kapitel \ref{sec:sovereignhyperscaler})
...
Erwägungsgrund 48 der \ac{DSGVO} erlaubt konzerninterne 
...
Zugriffspfad für den \ac{CLOUD-Act} offen lässt 
...
Schließlich ist die Regulierungsstrategie der \ac{EU} ein 
...
souveräne Cloud-Angebote zu entwickeln (vgl. Kapitel \ref{sec:sovereignhyperscaler}). 
Andererseits birgt intensive Regulierung das Risiko, 
Innovation und die Wettbewerbsfähigkeit der digitalen 
Transformation in der \ac{EU} zu hemmen und erzeugt \cite{draghi2024competitiveness}, 
...
einzelne Maßnahme die digitale Souveränität der \ac{EU} 
...
US-amerikanische Anbieter wie \ac{AWS} und Microsoft mussten 
...
noch besitzen sie die Hardware im Gegensatz zu dem Sovereign Hyperscaler Angebote (vgl. Kapitel \ref{sec:sovereignhyperscaler}). 

Das Ergebnis ist eine genuine strukturelle Souveränität: 
Kein CLOUD-Act-Beschluss kann auf Daten zugreifen, über 
die US-Hyperscaler operativ keine Kontrolle mehr haben. Dieses 
Modell ist für die \ac{EU} aus mehreren Gründen nicht 
direkt übertragbar weil es massive staatliche 
Investitionen in heimische Alternativen erfordert und erheblichen geopolitischen 
Widerstand auslösen würde. Es verdeutlicht jedoch, dass 
...
pragmatischerer Ansatz. Die \ac{EU} und ihre Mitgliedstaaten 
...
\ac{ECFR} empfiehlt genau diesen Ansatz: Europäische 
...
Data Act (vgl. Kapitel \ref{sec:data-act}) allein nicht gewährleisten kann.
...
Selbst wenn ein US-Gericht US-amerikanisches Cloud-Provider per \ac{CLOUD-Act} zur 
