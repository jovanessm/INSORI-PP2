...
Diese vier Dimensionen der Digitalsouveränität setzen voraus, dass Staaten und 
...
einen Kontrollverlust, der alle vier Dimensionen der Digitalsouveränität direkt 
betrifft: Die Infrastruktursouveränität wird eingeschränkt, da die technische 
Infrastruktur nicht mehr selbst betrieben wird. Die Datensouveränität steht unter 
Druck, da Daten auf fremden Servern gespeichert werden. Die Plattformsouveränität 
wird durch die Marktmacht weniger großer Anbieter gefährdet. Und die 
Entscheidungssouveränität schwindet, wenn kritische Systeme von externen 
...
und welche Risiken sich daraus für die EU ergeben.