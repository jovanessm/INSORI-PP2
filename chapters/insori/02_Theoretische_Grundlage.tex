...
private public and hybrid , scope auf public

Cloud computing implies that computing is not only operated on local computers,
but on centralized facilities by third-party computing and storage utilities \cite{magoules2013cloud}

Cloud essential characteristics \cite{mell2011nist}